...
export const faq: FaqItemInput[] = [
  ...
  // ------------------------------------------------------------ nonprofits
  {
    ...
    answer: "Nothing. We build and deliver the product free of charge.",
    audience: "nonprofits",
  },
  {
    id: "nonprofits-timeline",
    question: "How long does a project take?",
    answer: "Projects run over the academic year, from a fall kickoff to a spring handoff.",
    audience: "nonprofits",
  ...
  },
  {
    ...
    answer:
      "Nonprofits of any size, anywhere. Our partners have been based across the United States and abroad. What matters is a real problem that software can solve and a person on your side who can work with the team.",
    audience: "nonprofits",
    link: { label: "Where partners are from", href: "#partners" },
  },
  {
    id: "nonprofits-time",
    question: "How much of our time does it take?",
    answer:
      "A scoping call at the start, recurring meetings through the year, and check-ins where you try the work in progress and give feedback.",
    audience: "nonprofits",
  },
  {
    ...
    answer:
      "You do. At handoff you receive the product, the source code and the documentation, and your team is free to keep building on it.",
    audience: "nonprofits",
  },
  {
    id: "nonprofits-when",
    ...
    answer:
      "Any time. We match projects to teams before the fall kickoff, so inquiries that arrive over the summer are the easiest to place.",
    audience: "nonprofits",
