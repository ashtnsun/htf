 ...
 * vertical rails): eyebrow, title, one sentence and a "Learn more" button. Hovering the
 * panel turns the title green and puts the button in its hover state (green border, the
 * arrow cell fills), the treatment the project cards use; nothing moves. The two panels
 * share their row tracks (subgrid), so every line sits at the same height in both. Also the
 * "I'm a student / I'm a nonprofit" hand-off on /about.
 */
